    ...
    <footer className="bg-[linear-gradient(133deg,_#566270_0%,_#283444_100%)]">
      <div className="max-w-[1490px] mx-auto px-10 py-[120px]">
        <div className="flex flex-col items-center xl:items-start xl:flex-row xl:justify-between gap-12">
          <div className="w-full md:w-[40%] xl:auto flex flex-col items-start font-medium text-3xl lg:text-[32px]">
            <h2 className="text-white text-center xl:text-start font-medium text-3xl lg:text-[32px]">
              {newsletter}
            </h2>
            <div className="relative w-full md:max-w-[460px] mt-11">
              <input
                type="text"
                placeholder="Enter your Email"
                className="rounded-full w-full pl-6 py-4 bg-primary outline-none text-white text-base xs:text-lg placeholder-white"
              />
              <div
              ...
              >
                <h4 className="text-white text-base xs:text-lg">Subscribe</h4>
              </div>
            </div>
          </div>
